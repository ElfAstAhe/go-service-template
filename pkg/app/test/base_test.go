...
//    mockOrch.On("GetRunners").Return([]container.Runner{mockRunner1, mockRunner2}, nil).Maybe()
//
//    mockRunner1.On("GetName").Return("failing-runner").Maybe()
//    mockRunner2.On("GetName").Return("stable-runner").Maybe()
//
//    // Первый падает
