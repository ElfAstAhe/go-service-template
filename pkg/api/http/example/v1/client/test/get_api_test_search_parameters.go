...
// NewGetAPITestSearchParams creates a new GetAPITestSearchParams object,
...
// NewGetAPITestSearchParamsWithHTTPClient creates a new GetAPITestSearchParams object
// with the ability to set a custom HTTPClient for a request.
func NewGetAPITestSearchParamsWithHTTPClient(client *http.Client) *GetAPITestSearchParams {
	return &GetAPITestSearchParams{
		HTTPClient: client,
	}
}
...
/*
GetAPITestSearchParams contains all the parameters to send to the API endpoint

	for the get API test search operation.
...
func (o *GetAPITestSearchParams) WithDefaults() *GetAPITestSearchParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get API test search params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetAPITestSearchParams) SetDefaults() {
